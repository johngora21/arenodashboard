          ...
          <div className="mb-8">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex justify-start">
                <Button variant="ghost" onClick={() => router.push('/inventory')} className="flex items-center gap-2">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Inventory Approvals</h1>
                  <p className="text-slate-600 mt-1 text-base">Review and manage inventory-related approval requests</p>
                </div>
